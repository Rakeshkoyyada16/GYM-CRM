...
>(({ className, ...props }, ref) => (
  <h3 ref={ref} className={cn('text-sm font-semibold text-gray-900 tracking-[-0.01em]', className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <p ref={ref} className={cn('text-[13px] text-gray-500', className)} {...props} />
))
